...
object KvKeys {
    ...
    /** ISO date (yyyy-MM-dd) when a freeze was applied (no activity day); one per day max. */
    ...
    /** Morning reminder local time HH:mm (24h). */
    const val NOTIFICATION_TIME = "notifications.time"
    /** Evening reminder local time HH:mm (24h). */
    const val NOTIFICATION_EVENING_TIME = "notifications.evening_time"
